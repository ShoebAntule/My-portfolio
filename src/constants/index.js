...
export const PROJECTS = [
  {
    ...
    problem: "Need for a seamless online shopping experience with secure transactions.",
    work: "Built authentication flow, designed responsive UI, integrated payment gateway, handled state management.",
    technologies: ["React", "Node.js", "MongoDB", "Stripe"],
    url: "https://e-commerce-by-shoeb.netlify.app/account",
    github: "https://github.com/ShoebAntule/ecommerce-website"
  },
  {
    title: "IBI Cyber Security Website",
    image: project2,
    description: "Professional cybersecurity website showcasing services and solutions.",
    problem: "Businesses need accessible information about cybersecurity services.",
    work: "Designed responsive UI, implemented contact forms, optimized for performance, ensured accessibility.",
    technologies: ["React", "Tailwind CSS", "Next.js"],
    url: "https://ibigroup.vercel.app/",
    github: "https://github.com/ShoebAntule/ibi-cybersecurity"
  },

  {
    ...
    problem: "Music lovers want uninterrupted listening experience.",
    work: "Developed audio player, managed media library, optimized streaming performance.",
    technologies: ["JavaScript", "HTML", "CSS", "Web Audio API"],
    url: "https://tuneplaylists.freewebhostmost.com/",
    github: "https://github.com/ShoebAntule/tuneplaylist"
  },
  {
    title: "Blood Link",
    image: project1,
    description: "Blood Link is a web-based platform designed to help people connect with blood donors during emergencies. Not hosted – Code available on GitHub.",
    problem: "In emergency situations, finding the right blood donor quickly is difficult and time-sensitive.",
    work: "Designed the frontend user interface, implemented donor and request management logic, built forms for donor registration and blood requests, handled basic backend data flow and validation.",
    technologies: ["React", "Node.js", "Express", "MongoDB", "HTML", "CSS", "JavaScript"],
    github: "https://github.com/ShoebAntule/blood-link"
  },
];
